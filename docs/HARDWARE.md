...
| 2 | GMKtec NucBox M5 Ultra | AMD Ryzen 7 7730U / Radeon Vega 8 (`amdgpu`) | 2× Realtek 2.5GbE | Secure Boot off | *pending — box on order* | — | First AMD + first non-development configuration; validates the vendor-agnostic firmware set |
